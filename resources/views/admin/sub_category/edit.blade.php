            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update.subcat', $subcategory_info->id) }}" method="POST">
                        ...
                        <input type="text" class="form-control mb-2" name="subcategory_name" placeholder="Eelctronics"
                            value="{{ $subcategory_info->subcategory_name }}">

                        <label for="category_name" class="form-label fw-bold mb-2">Category Name</label>
                        <input readonly type="text" class="form-control mb-2" name="category_name" placeholder="Eelctronics"
                            value="{{ $subcategory_info->category->category_name }}">
                        ...
                        <textarea class="form-control mb-2" name="description" placeholder="Describe your Brand"
                            rows="10"> {{ $subcategory_info->description }}</textarea>

                        <label class="form-label fw-bold mb-2">Sub Category Icon</label>
                        <div class="mb-3">
                            <!-- Show existing images -->
                            @if($subcategory_info->icon_path)
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="position-relative image-wrapper" style="width: 150px;">
                                        <img src="{{ asset('storage/' . $subcategory_info->icon_path) }}" alt="Brand Logo"
                                            class="img-thumbnail w-100 h-auto object-fit">
                                        <button type="button"
                                            class="btn btn-danger btn-sm position-absolute top-0 end-0 remove-image"
                                            data-image-path="{{ $subcategory_info->icon_path }}">✖</button>
                                    </div>
                                </div>
                            @endif
                        ...
                        <input type="text" class="form-control mb-2" name="slug" placeholder="demo"
                            value="{{ $subcategory_info->slug }}" readonly>

                        <label class="form-label fw-bold mb-2" for="is_featured">
                            Is Featured
                        </label><br>
                        <input class="mb-2" type="checkbox" name="is_featured" id="is_featured" value="1" {{ $subcategory_info->is_featured ? 'checked' : '' }}> <br>
                        ...
                        <input type="text" class="form-control mb-2" name="meta_title" placeholder="Meta Titles"
                            value="{{ $subcategory_info->meta_title }}">
                        ...
                        <input type="text" class="form-control mb-2" name="meta_description" placeholder="Meta Descriptions"
                            value="{{ $subcategory_info->meta_description }}">
