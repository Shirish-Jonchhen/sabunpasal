            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control mb-2" name="product_name" placeholder="Harpic 750Ml" value="{{ $product->product_name }}">
                        ...
                        <input readonly type="text" class="form-control mb-2" name="sku" placeholder="SKU" value="{{ $product->sku }}">

                        <label for="category_id" class="form-label fw-bold mb-2">Product Category</label>
                        <input readonly type="text" class="form-control mb-2" name="category_id" placeholder="SKU" value="{{ $product->category->category_name }}">

                        {{-- <livewire:category-subcategory /> --}}

                        <label for="subcategory_id" class="form-label fw-bold mb-2">Product Subcategory</label>
                        <input readonly type="text" class="form-control mb-2" name="subcategory_id" placeholder="SKU" value="{{ $product->subcategory->subcategory_name }}">

                        {{-- <livewire:category-subcategory /> --}}

                        <label for="store_id" class="form-label fw-bold mb-2">Product Store</label>
                        <input readonly type="text" class="form-control mb-2" name="store_id" placeholder="SKU" value="{{ $product->store->store_name }}">
                        ...
                        <input type="number" class="form-control mb-2" name="regular_price" placeholder="100.00" value="{{ $product->regular_price }}">

                        <label for="discounted_price" class="form-label fw-bold mb-2">Discounted Price</label>
                        <input type="number" class="form-control mb-2" name="discounted_price" placeholder="50.00" value="{{ $product->discounted_price }}">

                        <label for="tax_rate" class="form-label fw-bold mb-2">Tax Rate</label>
                        <input type="number" class="form-control mb-2" name="tax_rate" placeholder="13" value="{{ $product->tax_rate }}">

                        <label for="stock_quantity" class="form-label fw-bold mb-2">Stock Quantity</label>
                        <input type="number" class="form-control mb-2" name="stock_quantity" placeholder="500" value="{{ $product->stock_quantity }}">
                        ...
                        <input readonly type="text" class="form-control mb-2" name="slug" placeholder="demo" value="{{ $product->slug }}">
                        ...
                        <input type="text" class="form-control mb-2" name="meta_title" placeholder="Meta Titles" value="{{ $product->meta_title }}">
