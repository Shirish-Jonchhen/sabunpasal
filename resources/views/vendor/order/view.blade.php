                ...
                <div class="order-detail-layout">
                    ...
                    <aside class="order-sidebar-details">
                        ...
                        {{-- <div class="detail-card">
                            ...
                            <p>{{ $order->order->payment_method == 'cod' ? 'Cash On Delivery' :
                                $order->order->payment_method }}</p>
                        </div>
                        ...
                        <div class="order-actions-detail">
                            ...
                            <button id="cancel-order-btn" class="btn btn-primary btn-block">Cancel
                                Order</button>
                            @else
                            <button class="btn btn-block bg-gray-300 text-gray-600" style=" cursor: not-allowed; " disabled>
                                Cancel order
                            </button>
                            @endif --}}
                        </div>
