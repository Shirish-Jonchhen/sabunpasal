...
<div class="position-relative">
    <input type="text" wire:model.live="search" placeholder="Search subcategory..." class="form-control mb-2"
        autocomplete="off" />
                    ...
                    <li class="list-group-item">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <small>ID: {{ $subcategory->id }} | Slug: {{ $subcategory->slug }} | Featured:
                                    {{ $subcategory->is_featured ? 'Yes' : 'No' }}</small>
                            </div>
