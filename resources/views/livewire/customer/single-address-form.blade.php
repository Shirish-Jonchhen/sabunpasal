<div class="checkout-layout">
    <div class="checkout-form">
        ...
        <form id="checkout-form" action="{{ route('user.create.single.order') }}" method="POST">
            @csrf
            @method('POST')
            ...
            <input type="hidden" name="product_variant_price_id" value="{{ $productVariantPriceId }}">
        ...
        <div id="summary-items">
            <div class="summary-item">
                <span class="item-name">
                    {{ $productVariantPrice->variant->product->name }} <br>
                    <small>{{ $productVariantPrice->variant->variant_name }}
                        {{ $productVariantPrice->variant->size }}</small>
                </span>
                <span class="item-qty">x{{ $quantity }}</span>
                <small class="item-old-price"
                    style='text-decoration:line-through;'>NRs.{{ $productVariantPrice->old_price * $quantity }}
                </small>
                <span class="item-price"> NRs.{{ $productVariantPrice->price * $quantity }}</span>
            </div>
        </div>
