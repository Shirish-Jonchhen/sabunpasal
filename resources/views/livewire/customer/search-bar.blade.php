...
<div class="search-bar">
    ...
    <form action="{{ route("user.all.product") }}" style="display: flex; width: 100%;">
        ...
        <button type="submit" class="search-button" aria-label="Submit search"><i class="fas fa-search"></i></button>
    </form>
                    ...
                    <li>
                        <a href="{{ route('product.show', $product->slug) }}" class="list-group-item">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                @endphp
                                @if ($imagePath)
                                    <img loading="lazy" src="{{ asset('storage/' . $imagePath) }}" alt="Icon" width="40" height="40"
                                        class="rounded bg-white" style="width: 40px; height: 40px; object-fit: contain;">
